...
import { Search as SearchIcon, Loader2, Clock, User, ArrowUpRight } from "lucide-react"
    ...
    <>
      ...
      <div className="sticky top-2 sm:top-4 z-20 mb-6 sm:mb-8">
        <div className="relative">
          <SearchIcon className="absolute left-4 sm:left-5 top-1/2 -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-slate-400 pointer-events-none" />
          <input
            ref={inputRef}
            type="text"
            value={searchQuery}
        ...
        {!isLoading && hasSearched && results.length === 0 && (
          <div className="text-center py-12 sm:py-16">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-slate-800/50 flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <SearchIcon className="h-6 w-6 sm:h-8 sm:w-8 text-slate-600" />
            </div>
